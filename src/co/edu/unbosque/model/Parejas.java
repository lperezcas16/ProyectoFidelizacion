...
public class Parejas implements Serializable {
	...
	public Parejas(String nombre, int cupo, double cantidad_cupo_asignado,
			double cantidad_cupo_restante, int edad,
	...
	public String toString() {
		return "Parejas [nombre=" + nombre + ", cupo=" + cupo
				+ ", cantidad_cupo_asignado=" + cantidad_cupo_asignado
				+ ", cantidad_cupo_restante=" + cantidad_cupo_restante
