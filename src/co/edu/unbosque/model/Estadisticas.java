...
public class Estadisticas {
	 ...
	 *            Este parametro representa el usuario que se busca en la lista
	 *            para luego buscar su edad != "".
	 ...
	 * 
	 * @param tituloInicio
	 *            Este parametro representa el titulo que se le asigna al pdf !=
	 *            "".
	 * 
	 * @param titulo_grafico
	 *            Este parametro representa el titulo que se pone al gráfico !=
	 *            "".
	 * 
	 * @param informacion
	 *            Este parametro representa la informacion que contiene el pdf
	 *            != "".
	 * 
	 *            *@param chart Este parametro representa la gráfica que se
	 *            visualiza en el pdf != "".
	 * 
	 * @param salida
	 *            Este parametro representa la salida de los datos para el pdf
	 *            != "".
	 * 
	 * @param jTable
	 *            Este parametro representa las tablas que se agregan al pdf !=
	 *            "".
	 * @param chart
	 *            Este parametro representa los datos del grafico. chart !=
	 *            null, chart != "".
	 * 
	 * 
	 * 
	 ...
	 * 
	 * @param texto
	 *            Este parametro representa el texto que se va a poner en pdf !=
	 *            "".
	...
	/**
	 * Este metodo genera el pdf con las edades obtenidas <b>post</b> se genéra
	 * el pdf que contiene la gráfica de las edades y se abre un filechooser
	 * para guardar el documento pdf <br>
	 * 
	 * @param lista_usuarios
	 *            Este parametro representa el usuario que se busca != "".
	 * 
	 * @param chart
	 *            Este parametro representa la gráfica a poner en pdf != "".
	 * 
	 * @param fileChooserGuardar
	 *            Este parametro representa el archivo que se guardará pdf !=
	 *            "".
	 * 
	 * @param jtable
	 *            Este parametro representa la tabla que se va a poner en pdf !=
	 *            "".
	 */
	public void generarPDFEdadesUsuarios(ArrayList<Usuario> lista_usuarios,
		...
		generarPDF("Estadisticas de la edad de los usuarios", "Estadisticas",
				informacion, chart, fileChooserGuardar, jtable);
	}

	/**
	 * Este metodo genera el pdf con los usuarios obtenidas <b>post</b> se
	 * genéra el pdf que contiene la gráfica de los usuarios y se abre un
	 * filechooser para guardar el documento pdf <br>
	 * 
	 * @param lista_usuarios
	 *            Este parametro representa el usuario que se busca != "".
	 * 
	...
	/**
	 * Este metodo genera uncalculo de las edades de los usuarios para buscar la
	 * mediana <b>post</b> Se en cuentra la mediana de la edad de todos los
	 * usuarios <br>
	 * 
	 * @param lista_usuarios
	 *            Este parametro representa el usuario que se busca != "".
	...
	/**
	 * Este metodo genera uncalculo de las edades de los usuarios para buscar la
	 * media <b>post</b> Se en cuentra la media de la edad de todos los usuarios <br>
	 * 
	 * @param lista_usuarios
	 *            Este parametro representa el usuario que se busca != "".
