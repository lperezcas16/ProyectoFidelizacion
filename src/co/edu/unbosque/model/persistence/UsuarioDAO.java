...
public class UsuarioDAO {
	 ...
	 * 
	 * @param cedula
	 *            el atributo que tendrán el sistema para validar la cedula
	 *            cedula != null, cedula !
	 * @param persona
	 ...
	 * 
	 * @param persona
	 *            Este parametro representa que debe de ingresar un valor de que
	 ...
	 * @return
	 */
	public void agregarUsuario(String nombre, String genero, String correo,
		...
		Usuario nuevo = new Usuario(nombre, genero, correo, usuario,
				contraseña, numeroTarjeta, cupoTarjeta, parejas, tipoUsuario);
