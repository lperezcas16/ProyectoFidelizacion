...
public class Solusoft {
	 ...
	 * parametros a la hora de generar un nuevo registro de compra.<br>
	 * 
	 * @param usuario_Inicio
	 *            Este paramentro representa el alias del usuario que ingresa en
	 *            el sistema, dandole cada vez un valor al atributo frente al
	 *            diferente alias. usuario_Inicio != null, usuario_Inicio != "".
	 */
	...
	/**
	 * En este metodo se crea cada vez una nueva secuencia de dieciseis numeros
	 * para la tarjeta de credito de cada usuario al registrarse. <b>post</b>Se
	 * asigna un numero de tarjeta de credito al momento del registro del
	 * usuario<br>
	 * 
	 * @param lista_usuarios
	 *            Hace referencia al arraylist de los usuarios ya creados.
	 *            lista_usuario != null, lista_usuarios != "".
	 * @return El valor de retorno es string representando aquel numero de
	 *         tarjeta creado.
	 */
	...
	/**
	 * Este metodo se llama en el momento del registro del usuario para
	 * asegurarse que no se esten ingresado los valores del correo y el alias de
	 * un usuario ya registrado.<b>post</b>Se valida si el usuario ingresado
	 * para registrarse ya se encuentra o no en el sistema<br>
	 * 
	 * @param correo
	 *            Es el correo ingresado a la hora del registro. correo != null,
	 *            correo != "".
	 * @param usuario
	 *            Representa el usuario o alias ingresado a la hora del
	 *            registro. usuario != null, usuario != "".
	 * @param lista_usuarios
	 *            Es la lista de usuarios ya registrados en el sistema. Es
	 *            frente a estos que se valida que el nuevo usuario no esta
	 *            dentro de aquella lista para poder proceder con el correcto
	 *            registro. lista_usuarios != null, lista_usuario != "".
	 ...
	 * asegurarse que no exista otro igual en el sistema.<b>post</b>Se valida si
	 * el usuario ingresado para registrarse ya se encuentra o no en el sistema<br>
	 * 
	 * @param nombre
	 *            Es el nombre ingresado a la hora de crear una nueva tienda.
	 *            nombre != null, nombre != "".
	 * @param direccion
	 *            Es la direccion ingresada a la hora de crear una nueva tienda.
	 *            direccion != null, direccion != "".
	 * @param lista_tiendas
	 *            Es la lista de tiendas ya registradas en el sistema. Es frente
	 *            a estos que se valida que la nueva tienda no esta ya inscrita
	 *            para proceder con la adiccion de ella. lista_tiendas != null,
	 *            lista_tiendas != "".
	 * @return El valor de retorno puede ser verdadero o falso representando la
	...
	/**
	 * Este metodo se llama a la hora de la creacion de un nuevo usuario para
	 * que se le envie correctamente un correo de confirmacion y bienvenida.
	 * <b>pre</b>Con anterioridad, se debio de validar que no hayan existencias
	 * del nuevo usuario en el sistema, con el resto de la informacion.<br>
	 * <b>post</b>Se envia el correo al correo ingresado.<br>
	 * 
	 * @param nuevo
	 *            Este parametro es el nuevo usuario registrado, el cual
	 *            contiene toda la informacion como nombre, correo, alias, entre
	 *            otros. nuevo != null, nuevo != "".
	 */
	...
	/**
	 * Este metodo se llama a la hora de la creacion de un nuevo horario para
	 * que se le envie correctamente un correo de confirmacion. <b>pre</b>Con
	 * anterioridad, ya se debió de registrar el usuario y tener al menos una
	 * pareja.<br>
	 * <b>post</b>Se envia el correo al correo guardado.<br>
	 * 
	 * @param usuario
	 *            Este parametro es el usuario que ha ingresado en la cuenta y
	 *            esta creando un nuevo horario, el cual contiene toda la
	 *            informacion como nombre, correo, alias, entre otros. usuario
	 *            != null, usuario != "".
	 * @param fecha
	 *            Representa la fecha del horario creado. fecha != null, fecha
	 *            != "".
	 * @param hora
	 *            Representa la hora del horario creado. hora != null, hora !=
	 *            "".
	 * @param pareja
	 *            Representa el nombre de la pareja con la cual se ha registrado
	 *            el horario. pareja != null, pareja != "".
	 * @param tienda
	 *            Representa el nombre de la tienda registrada en el horario.
	 *            tienda != null, tienda != "".
	 * @param genero
	 *            Representa el genero del usuario. genero != null, genero !=
	 *            "".
	 */
	public void enviarCorreoHorario(Usuario usuario, String fecha, String hora,
			String pareja, String tienda, String genero) {
		...
		try {
			...
			if (genero.equals("Mujer")) {
				mensaje = "Señora "
						...
						+ "\n"
						+ "\n"
						+ "Se ha añadido un nuevo horario en "
						+ tienda
						+ " el dia "
						+ fecha
						+ " a las "
			...
			adjunto.setDataHandler(new DataHandler(new FileDataSource(
					"./src/co/edu/unbosque/imagenes/correo.jpg")));
			adjunto.setFileName("CONTACTO");
	...
	/**
	 * Este metodo se llama a la hora de la creacion de una nueva compra para
	 * que se le envie correctamente un correo de confirmacion. <b>pre</b>Con
	 * anterioridad, ya se debió de registrar el usuario y tener al menos una
	 * pareja.<br>
	 * <b>post</b>Se envia el correo al correo guardado.<br>
	 ...
	 * @param usuario
	 *            Este parametro es el usuario que ha ingresado en la cuenta y
	 *            esta creando un nuevo registro de compra, el cual contiene
	 ...
	 * @param pareja
	 *            Representa el nombre de la pareja con la cual se ha registrado
	 *            la compra. pareja != null, pareja != "".
	 * @param tienda
	 *            Representa el nombre de la tienda registrada en la compra.
	 *            tienda != null, tienda != "".
	 * @param valorCompra
	 *            Representa el valor total de la compra. valorCompra != null,
	 *            valorCompra != "".
	 */
	public void enviarCorreoCompra(Usuario usuario, String genero,
			String pareja, String tienda, double valorCompra) {
		try {
	...
	/**
	 * Este metodo se llama para darle un valor al atributo cada vez que un
	 * usuario inicia sesion. Esto quiere decir que esta valor cambia frente al
	 * usuario y a // * las acciones hecha por este.<b>post</b>Se asigna un
	 * valor al atributo en una instancia inicial.<br>
	 * 
	 * @param valorCupo
	 *            Este parametro hace referencia al valor cuantitiativo que
	...
	/**
	 * Este metodo se llama para darle un valor al atributo cada vez que un
	 * usuario inicia sesion. Esta variable hace referencia al cupo restante que
	 * tiene el usuario, al ir reduciendose cada vez que agrega una nueva
	 * pareja.<b>post</b>Se asigna un valor al atributo en una instancia
	 * inicial.<br>
	 * 
	 * @param valorVariable
	 *            Este parametro hace referencia al cupo restante que tiene el
	 *            usuario. valorVariable != null, valorVariable != "".
	 */
	 ...
	 * usuario que acabó de ingresar al sistema. <b>post</b>Se fija un nuevo
	 * valor al atributo.<br>
	 * 
	 * @param usuario_inicio
	 *            Este parametro representa el nuevo valor en formato de cadena
	 *            de caracteres que va a tener el alias del usuario.
	 *            usuario_inicio != null, usuario_inicio != "".
	 */
	...
	/**
	 * Este metodo establece el valor del cupo. <b>post</b>Se fija un nuevo
	 * valor al atributo.<br>
	 * 
	 * @param valorCupo
	 *            Este parametro representa el nuevo valor en formato entero que
	 *            va a tener el cupo del usuario que acabo de ingresar en su
	 *            cuenta. valorCupo != null, valorCupo != "".
	 */
	...
	/**
	 * Este metodo devuelve el valor del cupo restante. <b>post</b>Se devuelve
	...
	/**
	 * Este metodo establece el valor del cupo restante del usuario.
	 * <b>post</b>Se fija un nuevo valor al atributo.<br>
	 * 
	 * @param valorVariable
	 *            Este parametro representa el nuevo valor en formato double que
	 *            va a tener el cupo restante del que acabo de ingresar en su
	 *            cuenta. valorVariable != null, valorVariable != "".
	 */
