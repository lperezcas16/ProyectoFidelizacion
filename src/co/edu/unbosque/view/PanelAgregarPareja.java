...
public class PanelAgregarPareja extends JPanel {
	 ...
	 * al atributo.<br>
	 * 
	 * @param campo_texto_cupo Este parametro representa el  valor del JTextField. != "".
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param campo_texto_cupo Este parametro representa el nuevo valor
	 *                 que va a tener el JTextField != "".
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param boton_agregar_nueva_pareja Este parametro representa el  valor del JButton. != "".
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param icono_boton Este parametro representa el  valor del Icon. != "".
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param icono_boton Este parametro representa el nuevo valor
	 ...
	 * al atributo.<br>
	 * 
	 * @param label_cupo_restante Este parametro representa el  valor del JLabel. != "".
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param label_cupo_restante Este parametro representa el nuevo valor
