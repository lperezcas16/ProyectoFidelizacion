...
public class VentanaGraficas extends JDialog {
	 ...
	 * automaticamente cuando se crea el objeto de la ventana <b>post</b>se hacen
	 * visibles los componentes del la ventana y se le agregan los paneles .<br>
	 */
	...
	/**
	 * Este es el metodo generarGraficoTorta el cual se ponen los gráficos en el
	 * panel <b>post</b>Se debe llamar el metodo y dar un valor a los parametros a
	 * la hora de generar un nuevo horario.<br>
	 * 
	 * @param titulo se le pone un titulo al gráfico de tortas != "".
	 * 
	 * @param data   Se le asignan los datos que van a estar en el gráfico != "".
	 * 
	 * @return Se retorna el atributo en formato JFreeChart.
	 */
	...
	/**
	 * Este es el metodo generarGraficoBarras el cual se ponen los gráficos en el
	 * panel <b>post</b>Se llama al método y se le asignan los datos para mostrar la
	 * gráfica con ellos .<br>
	 * 
	 * @param titulo se le pone un titulo al gráfico de tortas != "".
	 * 
	 * @param data   Se le asignan los datos que van a estar en el gráfico != "".
	...
	public JFreeChart generarGraficoBarras(String titulo, String ejeX, String ejeY, DefaultCategoryDataset data) {
		JFreeChart chart = ChartFactory.createBarChart3D(titulo, ejeX, ejeY, data, PlotOrientation.VERTICAL, true, true,
				true);
		ChartPanel panel_Grafico = new ChartPanel(chart);
		panel_Grafico.setBounds(0, 0, 694, 471);
		panel_Grafico.setVisible(true);
	...
	/**
	 * Este es el metodo fileChooseGuardar el cual se guarda el archivo en pdf es la
	 * dirección establecida por el usuario <b>post</b>Se debe llamar el metodo y
	 * dar un valor a los parametros a la hora de generar un nuevo horario.<br>
	 * 
	 * @return " " vacio
	 */
