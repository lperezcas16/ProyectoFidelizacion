...
public class PanelUsuarioInicio extends JPanel {
	 ...
	 * atributos y objectos . De esta manera el objecto es creado
	...
	/**
	 * Este metodo devuelve el valor del PanelAdmCuentas. <b>post</b>Se fija un nuevo valor
	 * al atributo.<br>
	 * 
	 * @param pnl_adm_cuentas Este parametro representa el  valor del PanelAdmCuentas.!= ""
	 */
	public PanelAdmCuentas getPnl_adm_cuentas() {
		return pnl_adm_cuentas;
	}
	/**
	 * Este metodo establece el valor del PanelAdmCuentas <b>post</b>Se fija un nuevo valor
	 * al atributo.<br>
	 * 
	 * @param pnl_adm_cuentas Este parametro representa el nuevo valor
	 *                 que va a tener el PanelAdmCuentas.!= ""
	 */
	public void setPnl_adm_cuentas(PanelAdmCuentas pnl_adm_cuentas) {
		this.pnl_adm_cuentas = pnl_adm_cuentas;
	}
	/**
	 * Este metodo devuelve el valor del PanelAsignarHorario. <b>post</b>Se fija un nuevo valor
	 * al atributo.<br>
	 * 
	 * @param pnl_asignar_horarios Este parametro representa el  valor del PanelAsignarHorario.!= ""
	 */
	public PanelAsignarHorario getPnl_asignar_horarios() {
		return pnl_asignar_horarios;
	}
	/**
	 * Este metodo establece el valor del PanelAsignarHorario <b>post</b>Se fija un nuevo valor
	 * al atributo.<br>
	 * 
	 * @param pnl_asignar_horarios Este parametro representa el nuevo valor
	 *                 que va a tener el PanelAsignarHorario.!= ""
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param pestañas Este parametro representa el nuevo valor
	...
	/**
	 * Este metodo devuelve el valor del PanelInfoSolusoft. <b>post</b>Se fija un nuevo valor
	 * al atributo.<br>
	 * 
	 * @param pnl_info_solusoft Este parametro representa el  valor del PanelInfoSolusoft.!= ""
	 */
	public PanelInfoSolusoft getPnl_info_solusoft() {
		return pnl_info_solusoft;
	}
	/**
	 * Este metodo establece el valor del PanelInfoSolusoft <b>post</b>Se fija un nuevo valor
	 * al atributo.<br>
	 * 
	 * @param pnl_info_solusoft Este parametro representa el nuevo valor
	 *                 que va a tener el PanelInfoSolusoft.!= ""
	 */
