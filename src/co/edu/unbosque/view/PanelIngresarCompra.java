...
public class PanelIngresarCompra extends JPanel {
	...
	/**
	 * Este metodo devuelve el valor del JJComboBox. <b>post</b>Se fija un nuevo
	 * valor al atributo.<br>
	 * 
	 * @return Retorna el atributo en formato JCombobox.
	 */
	 ...
	 * valor al atributo.<br>
	 * 
	 * @param combobox_tiendas Este parametro representa el nuevo valor que va a
	 *                         tener el JComboBox != "".
	 */
	 ...
	 * valor al atributo.<br>
	 * 
	 * @param imagen_boton_agregar_compra Este parametro representa el nuevo valor
	 *                                    que va a tener el ImageIcon si no hay
	 *                                    retorna null
	 */
	 ...
	 * valor al atributo.<br>
	 * 
	 * @param campo_texto_dinero Este parametro representa el nuevo valor que va a
	 *                           tener el JTextField != "".
	 */
	 ...
	 * al atributo.<br>
	 * 
	 * @param boton_agregar_compra Este parametro representa el nuevo valor que va a
	 *                             tener el JButton != "".
	 */
