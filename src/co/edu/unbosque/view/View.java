...
public class View extends JFrame {
	...
	public void actionListener(Controller controller) {
		...
		getPanel_admin().getPanel_informe().getCombo_eleccion()
				.addActionListener(controller);
		getPanel_admin().getPanel_informe().getCombo_Fecha()
				.addActionListener(controller);
		getPanel_admin().getPanel_informe().getCombo_hora()
				.addActionListener(controller);
		getPanel_admin().getPanel_informe().getCombo_tienda()
				.addActionListener(controller);
	...
	public void mostrarMensajes(String mensaje) {
		if (mensaje.equalsIgnoreCase("USUARIO_TRUE")) {
			...
			JOptionPane.showMessageDialog(null,
					"SU USUARIO Y SU CONTRASEÑA NO COINCIDEN");
			...
			JOptionPane.showMessageDialog(null,
					"ES NECESARIO PRIMERO ASINGAR UN VALOR AL CUPO");
