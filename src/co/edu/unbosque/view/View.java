...
public class View extends JFrame {
	...
	public void actionListener(Controller controller) {
		...
		getPanel_us_inicio().getPnl_adm_cuentas().getPnl_compras().getPnl_ingresar_compra().getBoton_agregar_compra()
				.addActionListener(controller);

	}

	public void mouseListener(MouseListener controller) {
		getPanel_us_inicio().getPnl_asignar_horarios().getPnl_seleccionar_tienda().getTable()
