...
public class TiendaDAOTest extends TestCase {
	...
	public void testUsuarioDAO() throws FileNotFoundException {
		...
		assertEquals("La cantidad de tiendas debe ser 2", 2,
				lista_tiendas.size());
	}

	public void testAgregarTienda() throws FileNotFoundException {
		setupEscenario();
		assertTrue(tiendas.agregarTienda("D1", "Calle 9", "08:00", "20:30",
				lista_tiendas));
		assertEquals(
				"Se agrega otra tienda y la cantidad de tiendas debe ser 3", 3,
				lista_tiendas.size());
	}
	...
	public void testEliminarTienda() throws FileNotFoundException {
		...
		assertEquals("La cantidad de tiendas debe ser 1", 1,
				lista_tiendas.size());
	}
